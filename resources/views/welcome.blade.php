...
<img src="https://www.bing.com/th?id=OIP.A08Vdgf1PuQb4EjAFZ6VKQHaE7" alt="Festival Banner" class="w-full h-full object-cover">
  ...
  <div class="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-center p-6">
     ...
     <p class="text-lg text-gray-200 max-w-xl mb-6">Discover the line-up, find answers to your questions, or get in touch with us.</p>
       <div class="space-x-4">
